...
def analyse(model, training_dataset, test_dataset, factsheet, config): 
    ...
    output = dict(
        ...
        equal_opportunity_difference = equal_opportunity_difference_score(model, training_dataset, test_dataset, factsheet, equal_opportunity_difference_thresholds),
        average_odds_difference = average_odds_difference_score(model, training_dataset, test_dataset, factsheet, average_odds_difference_thresholds),
...
def overfitting_score(model, training_dataset, test_dataset, factsheet, thresholds):
    ...
    try:
        ...
        underfitting_score = np.digitize(abs(test_accuracy), [0.8, 0.85, 0.9, 0.95], right=False) + 1
...
def equal_opportunity_difference_score(model, training_dataset, test_dataset, factsheet, thresholds):
...
def average_odds_difference_score(model, training_dataset, test_dataset, factsheet, thresholds):
