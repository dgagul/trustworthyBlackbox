...
from Score.algorithms.fairness import analyse as analyse_fairness
from Score.algorithms.explainability import analyse as analyse_explainability
from Score.algorithms.robustness import analyse as analyse_robustness
from Score.algorithms.methodology import analyse as analyse_methodology
import collections
...
def get_final_score(model, train_data, test_data, config_weights, mappings_config, factsheet, solution_set_path, recalc=False):
    ...
    with open('Score/configs/mappings/default.json', 'r') as f:
